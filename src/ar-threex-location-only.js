            ...
            return (() => {
                ...
                class s {
                    constructor(t, i) {
                        ...
                        void 0 === i ? (o = document.createElement("video"), o.setAttribute("autoplay", !0), o.setAttribute("playsinline", !0), o.style.display = "none", document.body.appendChild(o)) : o = document.querySelector(i),
                    ...
                    constructor(t) {
                        ...
                        this.connect = function () {
                            ...
                            void 0 !== window.DeviceOrientationEvent && "function" == typeof window.DeviceOrientationEvent.requestPermission ? window.DeviceOrientationEvent.requestPermission().then((t => {
                                ...
                                })) : (window.addEventListener("orientationchange", s), window.addEventListener(i.orientationChangeEventName, n)),
                            i.enabled = !0
                        },
                        ...
                        this.update = function () {
                            ...
                            if (t) {
                                ...
                                8 * (1 - o.dot(i.object.quaternion)) > 1e-6 && (o.copy(i.object.quaternion), i.dispatchEvent(d))
                            }
                        },
